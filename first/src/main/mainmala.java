...
public class mainmala extends JFrame {
	...
	public mainmala() {
		...
		btnMara1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				dispose( ) ;
				setVisible(false) ;
				new Choice().setVisible(true) ; // 매장/포장 선택창으로 
			}
		});
